    ...
    async function loadDomains() {
      ...
      if(result.success){
        ...
        result.data.forEach(item => {
          ...
          // 设置进度条颜色
          let progressColor = "#4a90e2";
          if(progress > 80) {
            progressColor = "#e94b35"; // 红色，接近到期
          } else if(progress > 60) {
            progressColor = "#f39c12"; // 橙色，过半
          }
          ...
          tr.innerHTML = \`
            ...
            <td>
              <div class="progress-container">
                <div class="progress-bar" style="width: \${progress.toFixed(1)}%; background: \${progressColor};">
                  \${progress.toFixed(1)}%
                </div>
              </div>
            </td>
